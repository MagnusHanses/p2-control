...
class Agent():
    ...
    def __init__(self, state_size, action_size, num_agents,random_seed):
        ...
        self.critic_local = Critic(state_size, action_size, random_seed, 128, 128).to(device)
        self.critic_target = Critic(state_size, action_size, random_seed, 128, 128).to(device)
